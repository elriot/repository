...
$(document).ready(function () {
		...
		$.ajax({
			...
			url: 'management_chartData1_JSON.jsp',
...
<table id="notice">
<tr><th class="tno">PlayMain</th>
    <th class="tread">Count</th>
</tr>
<%

OmemberDao dao = OmemberDao.getInstance();
List<Map> mapList = dao.getCountPlaymain();
int totalCheck = 0;
if (mapList!=null){
    for(int i=0; i<mapList.size(); i++){
        Map<Object, Object> map = mapList.get(i);
        String playmain = (String) map.get("playmain");
        int count = (Integer) map.get("count");
        totalCheck += count; 
        %>
        <tr><td id="playmain"><%=playmain %></td><td id="count"><%=count %></td></tr>
