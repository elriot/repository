...
<form action="fupdatePro.jsp?pageNum=<%=pageNum %>" method="post" enctype="multipart/form-data" name="frm">
...
<tr>
	<th>파일</th>
	<td>
		<input type="file" name="filename"><%=board.getFilename() %>
		<input type="hidden" name="filename2" value="<%=board.getFilename() %>">
	</td>
</tr>
<tr><th>내용</th>
